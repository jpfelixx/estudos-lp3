#Ex04 - Simulador 'de Eleições': Crie um programa que simule uma votação com três candidatos. O programa deve pedir ao usuário
# para votar várias vezes e, no final, mostrar o número de votos de cada candidato e quem foi o vencedor.
candidatos = {
